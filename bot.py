    ...
    if await is_user_subscribed(user_id, context):
        ...
        if isinstance(result, InlineKeyboardMarkup):
           response_message = await loading_message.edit_text(
            f"🔍 **Search Results** for *'{movie_name}'* 🍿\n\n"
            "💀 *Note*: Search results will disappear after 1 minute due to copyright policies. ⏳\n\n"
            "🚀 Buy Premium for just *$12/year* and enjoy direct downloading! 💎 Contact here: AdsZilla[https://t.me/ads_zilla_bot] 📩"
            , reply_markup=result, parse_mode="Markdown")
